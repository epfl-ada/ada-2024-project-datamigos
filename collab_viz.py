...
class StaticGraph:
    ...
    def create_figure(self):
        ...
        for edge in self.graph.edges(data=True):
            ...
            if side_0 == side_1:
                if side_0 == 'Western':
                    line_color = f'rgba(0, 0, 255, {(weight / max_collaboration) * 5})'  # Blue
                elif side_0 == 'Eastern':
                    line_color = f'rgba(255, 0, 0, {(weight / max_collaboration) * 5})'  # Red
                else:
                    line_color = f'rgba(0, 0, 0, 0.8)'  # Black
            else:
                line_color = f'rgba(0, 0, 0, 0.8)'  # Black
        ...
        for (c1, c2), weight in self.collaboration_count.items():
            if c1 in COUNTRY_COORDS and c2 in COUNTRY_COORDS:
                ...
                if self.country_cold_war_side.get(c1) == 'Western' and self.country_cold_war_side.get(c2) == 'Western':
                    edge_colors.append(f'rgba(0, 0, 255, {(weight / max_collaboration) * 5})')
                elif self.country_cold_war_side.get(c1) == 'Eastern' and self.country_cold_war_side.get(c2) == 'Eastern':
                    edge_colors.append(f'rgba(255, 0, 0, {(weight / max_collaboration) * 5})')
                else:
                    edge_colors.append('rgba(0, 0, 0, 0.8)')
